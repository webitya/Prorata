...
const Navbar = () => {
  ...
  <MenuOutlined className="!text-white text-2xl" onClick={() => setVisible(true)} />
      ...
      >
        ...
        <Link to="/faqs" className="cursor-pointer hover:text-gray-300 text-white"><span className="cursor-pointer hover:text-gray-300 text-white" onClick={() => setVisible(false)}>FAQ’S</span></Link> 
        <Link to="/about" className="cursor-pointer hover:text-gray-300 text-white"><span className="cursor-pointer hover:text-gray-300 text-white" onClick={() => setVisible(false)}>ABOUT US</span></Link> 
